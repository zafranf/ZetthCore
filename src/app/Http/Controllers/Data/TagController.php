...
class TagController extends AdminController
{
    ...
    public function store(Request $r)
    {
        ...
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> menambahkan label "' . $tag->name . '"');
    ...
    public function update(Request $r, Term $tag)
    {
        ...
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> memperbarui label "' . $tag->name . '"');
    ...
    {
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> menghapus label "' . $tag->name . '"');
