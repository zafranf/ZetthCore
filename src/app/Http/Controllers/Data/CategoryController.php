...
class CategoryController extends AdminController
{
    ...
    public function store(Request $r)
    {
        ...
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> menambahkan kategori "' . $category->name . '"');
    ...
    public function update(Request $r, Term $category)
    {
        ...
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> memperbarui kategori "' . $category->name . '"');
    ...
    {
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> menghapus kategori "' . $category->name . '"');
