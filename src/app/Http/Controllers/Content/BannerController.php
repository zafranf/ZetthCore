...
class BannerController extends AdminController
{
    ...
    public function store(Request $r)
    {
        ...
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> menambahkan spanduk "' . $banner->title . '"');
    ...
    public function update(Request $r, Banner $banner)
    {
        ...
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> memperbarui spanduk "' . $banner->title . '"');
    ...
    {
        /* log aktifitas */
        $this->activityLog('<b>[~name]</b> menghapus spanduk "' . $banner->title . '"');
