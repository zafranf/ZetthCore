...
<html>
	<head>
		...
		<link rel="shortcut icon" href="<?=url('themes/admin/AdminSC/plugins/filemanager/img/ico/favicon.ico')?>">
		<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
		<link rel="stylesheet" href="<?=url('themes/admin/AdminSC/plugins/filemanager/css/jquery.fileupload.css')?>">
		<link rel="stylesheet" href="<?=url('themes/admin/AdminSC/plugins/filemanager/css/jquery.fileupload-ui.css')?>">
		<!-- CSS adjustments for browsers with JavaScript disabled -->
		<noscript><link rel="stylesheet" href="<?=url('themes/admin/AdminSC/plugins/filemanager/css/jquery.fileupload-noscript.css')?>"></noscript>
		<noscript><link rel="stylesheet" href="<?=url('themes/admin/AdminSC/plugins/filemanager/css/jquery.fileupload-ui-noscript.css')?>"></noscript>
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jplayer/2.2.0/skin/blue.monday/jplayer.blue.monday.min.css" />
		<link href="<?=url('themes/admin/AdminSC/plugins/filemanager/css/style.css')?>?v=<?php echo $version; ?>" rel="stylesheet" type="text/css" />
	<!--[if lt IE 8]><style>
	...
	<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/plugins.js')?>?v=<?php echo $version; ?>"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jplayer/2.9.2/jplayer/jquery.jplayer.min.js"></script>
	<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/modernizr.custom.js')?>"></script>
...
foreach ($config['aviary_defaults_config'] as $aopt_key => $aopt_val) {
	...
	<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/include.js')?>?v=<?php echo $version; ?>?v=<?php echo $version; ?>"></script>
</head>
<body>
...
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.iframe-transport.js')?>?v=<?php echo $version; ?>"></script>
<!-- The basic File Upload plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload.js')?>?v=<?php echo $version; ?>"></script>
<!-- The File Upload processing plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload-process.js')?>?v=<?php echo $version; ?>"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload-image.js')?>?v=<?php echo $version; ?>"></script>
<!-- The File Upload audio preview plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload-audio.js')?>?v=<?php echo $version; ?>"></script>
<!-- The File Upload video preview plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload-video.js')?>?v=<?php echo $version; ?>"></script>
<!-- The File Upload validation plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload-validate.js')?>?v=<?php echo $version; ?>"></script>
<!-- The File Upload user interface plugin -->
<script src="<?=url('themes/admin/AdminSC/plugins/filemanager/js/jquery.fileupload-ui.js')?>?v=<?php echo $version; ?>"></script>
...
$file_prevent_rename = false;
            ...
            ?> <?php if (!$is_icon_thumb) {echo "hide";}?>"><?php echo $file_array['extension'] ?></div>
					<div class="img-container-mini">
					<?php if ($mini_src != "") {?>
