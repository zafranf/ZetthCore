  ...
  <div class="container-fluid">
    <div class="row">
      <div id="btn-quick-box" class="col-sm-12">
        ...
        <div class="btn btn-default btn-quick">
          <a href="{{ _url(app('admin_path') . '/content/posts/create') }}">
            <div class="row">
        ...
        <div class="btn btn-default btn-quick">
          <a href="{{ _url(app('admin_path') . '/content/pages/create') }}">
            <div class="row">
        ...
        <div class="btn btn-default btn-quick">
          <a href="{{ _url(app('admin_path') . '/report/comments') }}">
            <div class="row">
        ...
        <div class="btn btn-default btn-quick">
          <a href="{{ _url(app('admin_path') . '/report/inbox') }}">
            <div class="row">
    ...
    <div class="row">
      <div class="col-sm-12" id="box-pageview-chart">
        <div class="loading">Memuat<img src="{{ _url('themes/admin/AdminSC/images/loading-flat.gif') }}"></div>
      ...
      <div class="col-sm-12 col-md-6" id="box-popular-post">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <a href="{{ _url(app('admin_path') . '/content/posts') }}" class="btn btn-default btn-sm pull-right"><i class="fa fa-eye"></i> Semua</a>
              @endif
            </div>
      ...
      <div class="col-sm-12 col-md-6" id="box-recent-comment">
        <div class="panel panel-default">
          <div class="panel-heading">
            Komentar Terbaru
            @if (Auth::user()->can('admin.report.comments.index'))
            <a href="{{ _url(app('admin_path') . '/report/comments') }}" class="btn btn-default btn-sm pull-right"><i class="fa fa-eye"></i> Semua</a>
            @endif
          </div>
          <div class="panel-body no-padding">
            <div class="loading">Memuat<img src="{{ _url('themes/admin/AdminSC/images/loading-flat.gif') }}"></div>
...
@section('scripts')
  ...
  $(function(){
    ...
    function combobox(start, end, label) {
      ...
      /* $('#pageview-chart').html("Memuat<img src=\"{{ _url('themes/admin/AdminSC/images/loading-flat.gif') }}\">");
      ...
      if (CONNECT){
        /* get data pageview */
        $.ajax({
          url: "{{ _url(app('admin_path') . '/ajax/pageview') }}",
          data: {
            range: rangetype,
        ...
        $.ajax({
          url: "{{ _url(app('admin_path') . '/ajax/popularpost') }}",
          data: {
            start: start.format('YYYY-MM-DD'),
            end: end.format('YYYY-MM-DD')
          },
        ...
        $.ajax({
          url: "{{ _url(app('admin_path') . '/ajax/recentcomment') }}",
          data: {
            start: start.format('YYYY-MM-DD'),
            end: end.format('YYYY-MM-DD')
          },
