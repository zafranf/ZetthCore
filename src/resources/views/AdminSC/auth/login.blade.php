      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            @endphp
            <center>
              <img src="{{ _get_image("assets/images/" . app('site')->logo, _url("themes/admin/AdminSC/images/" . (app('site')->logo ?? 'logo.v2.png'))) }}" alt="{{ app('site')->name }} Logo" style="margin-bottom: 20px; width: {{ $w }}px;">
            </center>
            <form class="form-horizontal" role="form" method="POST" action="{{ _url(app('admin_path') . '/login') }}">
              ...
              <div class="form-group">
                <div class="col-md-7 col-md-offset-4">
                  ...
                  <a class="btn btn-link" href="{{ _url(app('admin_path') . '/password/reset') }}">Lupa sandi?</a>
                  {!! csrf_field() !!}
                </div>
              </div>
            </form>
