            ...
            <div class="col-md-8">
              <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-new thumbnail">
                  <img src="{{ getImage("/assets/images/" . app('site')->logo, url(adminPath() . "/themes/admin/AdminSC/images/logo.v2.png")) }}">
                </div>
              ...
              <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                <div class="form-control" data-trigger="fileinput">
                  <div class="fileinput-new thumbnail"
                    ...
                    <img src="{{ getImage("/assets/images/" . app('site')->icon, url(adminPath() . "/themes/admin/AdminSC/images/logo.v2.png")) }}" width="20">
                  </div>
