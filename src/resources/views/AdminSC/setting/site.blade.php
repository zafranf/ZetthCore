...
<div class="panel-body">
  <form class="form-horizontal" action="{{ url($current_url) }}/{{ app('site')->id ?? '' }}" method="post"
    ...
    <div class="row">
      <div class="col-md-6">
            ...
            <div class="fileinput fileinput-new input-group" data-provides="fileinput">
              <div class="form-control" data-trigger="fileinput">
                <div class="fileinput-new thumbnail"
                  ...
                  <img
                    src="{{ _get_image("assets/images/" . app('site')->icon, url("themes/admin/AdminSC/images/" . (app('site')->logo ?? 'logo.v2.png'))) }}"
                    width="20">
                </div>
        ...
        {{-- <div class="form-group" {!! (Auth::user()->id != 1)?'style="display:none;"':'' !!}>
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="max_login_failed" value="{{ app('site')->max_login_failed ?? '' }}"
        maxlength="1">
    ...
    {{-- <div class="form-group" {!! (Auth::user()->id != 1)?'style="display:none;"':'' !!}>
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="lockout_time" value="{{ app('site')->lockout_time ?? '' }}"
    maxlength="2">
...
<div class="form-group" {!! (Auth::user()->id != 1)?'style="display:none;"':'' !!}>
  ...
  <div class="col-md-8">
    <input type="number" class="form-control" id="perpage" name="perpage" value="{{ app('site')->perpage ?? 0 }}"
      placeholder="Jumlah data perhalaman.." min="3" max="100">
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="checkbox">
      ...
      <div class="col-xs-6 col-sm-3">
        <label>
          <input type="checkbox" id="enable-like" name="enable_like" {{ (!app('site')->enable_like) ? '' : 'checked' }}>
          Suka
        </label>
      </div>
      <div class="col-xs-6 col-sm-3">
...
<div class="col-md-6">
  <h4>Media Sosial <span class="btn btn-default btn-xs pull-right" id="btn-add-socmed"><i class="fa fa-plus"></i></span>
  </h4>
  <hr>
  <div class="form-group">
    ...
    <div class="col-md-8">
      ...
      <div class="col-md-9 col-xs-6 no-padding">
        <input type="text" class="form-control" id="socmed-uname" name="socmed_uname[]" placeholder="Nama/ID akun.."
          maxlength="50">
      </div>
      @endif
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="text" class="form-control" id="keywords" name="keywords" value="{{ app('site')->keywords ?? '' }}"
        placeholder="Kata kunci situs.." maxlength="50">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="coordinate" class="col-md-4 control-label">
      ...
      <small class="help-block">
        Garis lintang dan garis bujur.<br>
        (contoh:
        <b>Monas</b> atau
