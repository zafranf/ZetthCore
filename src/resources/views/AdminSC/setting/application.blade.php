			...
			<div class="row">
				<div class="col-md-6">
							...
							<div class="fileinput fileinput-new input-group" data-provides="fileinput">
								<div class="form-control" data-trigger="fileinput">
									<div class="fileinput-new thumbnail" style="width:20px;padding:0;margin-bottom:8px;position:absolute;left:5px;">
										<img src="{{ _get_image("assets/images/" . app('setting')->icon, url("themes/admin/AdminSC/images/" . (app('setting')->logo ?? 'logo.v2.png'))) }}" width="20">
									</div>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" class="form-control autofocus" id="name" name="name" value="{{ app('setting')->name ?? '' }}" placeholder="Nama situs.." maxlength="50">
						</div>
					</div>
					<div class="form-group">
						<label for="slogan" class="col-md-4 control-label">Slogan</label>
						<div class="col-md-8">
							<input type="text" class="form-control" id="tagline" name="tagline" value="{{ app('setting')->tagline ?? '' }}" placeholder="Slogan situs.." maxlength="100">
						</div>
					</div>
					<div class="form-group">
						<label for="email" class="col-md-4 control-label">Surel</label>
						<div class="col-md-8">
							<input type="text" class="form-control" id="email" name="email" value="{{ app('setting')->email ?? '' }}" placeholder="Alamat surel.." maxlength="100">
						</div>
					</div>
					<div class="form-group">
						<label for="phone" class="col-md-4 control-label">Telepon</label>
						<div class="col-md-8">
							<input type="text" class="form-control" id="phone" name="phone" value="{{ app('setting')->phone ?? '' }}" placeholder="Nomor telepon.." maxlength="16">
						</div>
					</div>
					{{-- <div class="form-group" {!! (Auth::user()->id != 1)?'style="display:none;"':'' !!}>
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="max_login_failed" value="{{ app('setting')->max_login_failed ?? '' }}" maxlength="1">
					...
					{{-- <div class="form-group" {!! (Auth::user()->id != 1)?'style="display:none;"':'' !!}>
						...
						<div class="col-md-8">
							<input type="text" class="form-control" name="lockout_time" value="{{ app('setting')->lockout_time ?? '' }}" maxlength="2">
					...
					<div class="form-group" {!! (Auth::user()->id != 1)?'style="display:none;"':'' !!}>
						...
						<div class="col-md-8">
							<input type="number" class="form-control" id="perpage" name="perpage" value="{{ app('setting')->perpage ?? 0 }}" placeholder="Jumlah data perhalaman.." min="3" max="100">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<div class="checkbox">
								<div class="col-xs-6 col-sm-3">
									<label>
										<input type="checkbox" id="enable-subscribe" name="enable_subscribe" {{ (!app('setting')->enable_subscribe) ? '' : 'checked' }}> Langganan
									</label>
								</div>
								<div class="col-xs-6 col-sm-3">
									<label>
										<input type="checkbox" id="enable-comment" name="enable_comment" {{ (!app('setting')->enable_comment) ? '' : 'checked' }}> Komentar
									</label>
								</div>
								<div class="col-xs-6 col-sm-3">
									<label>
										<input type="checkbox" id="enable-like" name="enable_like" {{ (!app('setting')->enable_like) ? '' : 'checked' }}> Suka
									</label>
								</div>
								<div class="col-xs-6 col-sm-3">
									<label>
										<input type="checkbox" id="enable-share" name="enable_share" {{ (!app('setting')->enable_share) ? '' : 'checked' }}> Sebar
									</label>
								</div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<select class="form-control custom-select2" id="status" name="status">
								<option value="1" {{ (app('setting')->status == 1) ? 'selected' : '' }}>Aktif</option>
								<option value="0" {{ (app('setting')->status == 0) ? 'selected' : '' }}>Segera Hadir</option>
								<option value="2" {{ (app('setting')->status == 2) ? 'selected' : '' }}>Perbaikan</option>
							</select>
						</div>
					</div>
				...
				<div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="socmed-uname" name="socmed_uname[]" placeholder="Nama/ID akun.." maxlength="50">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" id="keywords" name="keywords" value="{{ app('setting')->keywords ?? '' }}" placeholder="Kata kunci situs.." maxlength="50">
						</div>
					</div>
					<div class="form-group">
						<label for="description" class="col-md-4 control-label">Deskripsi</label>
						<div class="col-md-8">
							<textarea class="form-control" id="description" name="description" rows="4" placeholder="Penjelasan singkat mengenai situs..">{{ app('setting')->description ?? '' }}</textarea>
						</div>
					</div>
					<div class="form-group">
              ...
              Google Analytics
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<textarea class="form-control" id="address" name="address" rows="4" placeholder="Alamat lengkap.." maxlength="280">{{ app('setting')->address ?? '' }}</textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" id="coordinate" name="coordinate" value="{{ app('setting')->coordinate ?? '' }}" placeholder="Titik koordinat.." maxlength="30">
						</div>
					</div>
				</div>
			</div>
