...
class CreateActivityLogsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('activity_logs', function (Blueprint $table) {
            ...
            $table->index(['club_id', 'user_id', 'created_at', 'site_id'], 'idx_club_user_created_site');
            $table->index(['user_id', 'created_at', 'site_id'], 'idx_user_created_site');
