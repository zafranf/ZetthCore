...
class GuideSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /* Dasbor - Atur Tanggal */
        $content = '<div id="z-date-range" class="pull-right" style="background:#fff;cursor:pointer;padding:5px 10px;border:1px solid coral;margin-top:-40px;margin-right:45px;border-top-left-radius:5px;border-bottom-left-radius:5px;color:coral;font-size: 12px;"><i class="fa fa-calendar"></i>&nbsp;<span>[~dates]</span> <b class="caret"></b></div><div id="btn-refresh" title="Segarkan" class="pull-right" style="background:#fff;cursor:pointer;padding:5px 10px;border:1px solid coral;margin-top:-40px;margin-right:15px;border-top-right-radius:5px;border-bottom-right-radius:5px;color:coral;font-size: 12px;"><i class="fa fa-refresh"></i></div>';
